    ...
    public void checkTile(Entity entity) {
        ...
        switch (entity.direction) {
            case "up":
                ...
                tileNum1 = game.tileManager.mapTileNum[entityLeftCol][entityTopRow];
                tileNum2 = game.tileManager.mapTileNum[entityRightCol][entityTopRow];
            ...
            case  "up left":
                ...
                tileNum1 = game.tileManager.mapTileNum[entityLeftCol][entityTopRow];
                tileNum2 = game.tileManager.mapTileNum[entityRightCol][entityBottomRow];
                if (game.tileManager.tile.get(tileNum1).collision || game.tileManager.tile.get(tileNum2).collision) {
                    entity.collisionOn = true;
                }
                break;
            ...
            case "down":
                ...
                tileNum1 = game.tileManager.mapTileNum[entityLeftCol][entityBottomRow];
                tileNum2 = game.tileManager.mapTileNum[entityRightCol][entityBottomRow];
                if (game.tileManager.tile.get(tileNum1).collision || game.tileManager.tile.get(tileNum2).collision) {
                    entity.collisionOn = true;
                }
    ...
    public int checkObject(Entity entity, boolean player) {
        ...
        for (int i = 0; i < game.obj.size(); i++) {
            if (game.obj.get(i) != null) {
                ...
                game.obj.get(i).solidArea.x = game.obj.get(i).worldX + game.obj.get(i).solidArea.x;
                game.obj.get(i).solidArea.y = game.obj.get(i).worldY + game.obj.get(i).solidArea.y;
                ...
                if (entity.solidArea.intersects(game.obj.get(i).solidArea)) {
                    if (game.obj.get(i).collision) {
                        entity.collisionOn = true;
                    }
                    if (player) {
                        index = i;
                ...
                game.obj.get(i).solidArea.x = game.obj.get(i).solidAreaDefaultX;
                game.obj.get(i).solidArea.y = game.obj.get(i).solidAreaDefaultY;
            }
        }

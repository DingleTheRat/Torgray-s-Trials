...
public class TileManager {
     ...
     * @param tilePosition A {@link Position}, which is a class that holds the X and Y values of your target tile.
     * @return True if at least one point is collidable, false if not.
     **/
    public static boolean getTileCollision(World world, Position tilePosition) {

 ...
 * It's not recommended to manually modify the health variable manually, but instead give the entity a {@link DamageSignal} or {@link HealSignal}.
...
public class HealthComponent implements Component {
    ...
    public int health;
    /// The {@link DamageSignal} gives the entity an invincibility period, stopping the entity from taking damage for a set time. This is the set time.
    ...
    /**
     * @param maxHealth The maximum amount of health the entity can have.
     * @param health How much health the entity start off with.
     * @param invincibilityLength The {@link DamageSignal} gives the entity an invincibility period, stopping the entity from taking damage for a set time. This is the set time.
    ...
    /**
     * Alternate constructor without {@code removeOnDeath}, which will be set to true.
     * @param maxHealth The maximum amount of health the entity can have.
     * @param health How much health the entity start off with.
     * @param invincibilityLength The {@link DamageSignal} gives the entity an invincibility period, stopping the entity from taking damage for a set time. This is the set time.
     **/
    ...
    /**
     * Alternate constructor without {@code health}, which will be set to the maxHealth.
     * @param maxHealth The maximum amount of health the entity can have.
     * @param health How much health the entity start off with.
     * @param invincibilityLength The {@link DamageSignal} gives the entity an invincibility period, stopping the entity from taking damage for a set time. This is the set time.
     **/
    ...
    /**
     * Alternate constructor without {@code health} and {@code removeOnDeath}, which will be set to the maxHealth and true.
     * @param maxHealth The maximum amount of health the entity can have.
     * @param health How much health the entity start off with.
     * @param invincibilityLength The {@link DamageSignal} gives the entity an invincibility period, stopping the entity from taking damage for a set time. This is the set time.
     **/
